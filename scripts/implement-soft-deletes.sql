...
-- Messages already has deleted_at and deleted_by columns
...
ALTER TABLE google_sheets ADD COLUMN IF NOT EXISTS deleted_at TIMESTAMP WITH TIME ZONE;
ALTER TABLE google_sheets ADD COLUMN IF NOT EXISTS deleted_by VARCHAR(255);
